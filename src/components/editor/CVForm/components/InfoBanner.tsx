...
export const InfoBanner = ({ t, onClose }: InfoBannerProps) => (
    <div className="bg-[rgba(30,58,138,0.2)] border border-[rgba(30,58,138,0.5)] rounded-lg p-3 text-xs text-blue-200 flex items-start gap-2 relative animate-in fade-in slide-in-from-top-2">
